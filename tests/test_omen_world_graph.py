...
class WorldGraphIntegrationTest(unittest.TestCase):
    ...
    def test_plain_text_forward_uses_observation_trace_world_path(self) -> None:
        ...
        self.assertGreaterEqual(out["sym_trace_grounding_world_state_hypothetical_facts"], 1.0)
        ...
        self.assertGreaterEqual(out["world_graph_grounding_world_state_hypothetical_facts"], 1.0)
    ...
    def test_grounding_memory_records_enrich_world_graph_metadata(self) -> None:
        ...
        self.assertGreaterEqual(graph_batch.metadata.get("grounding_world_state_hypothetical_facts", 0.0), 1.0)
