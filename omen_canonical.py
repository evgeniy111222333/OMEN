...
CANONICAL_OMEN_SPEC = CanonicalArchitectureSpec(
    ...
    z_semantics="graph_native_perception_and_context_enriched_graph_primary_world_state",
    world_model_mode="graph_native_execution_trace_primary_with_state_anchored_fallback",
